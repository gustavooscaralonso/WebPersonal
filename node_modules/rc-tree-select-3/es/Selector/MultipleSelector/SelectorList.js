...
var SelectorList = function SelectorList(props) {
  ...
  return /*#__PURE__*/React.createElement(CSSMotionList, {
    keys: nodeKeys,
    ...
    if (type === NODE_SELECTOR) {
      return /*#__PURE__*/React.createElement(Selection, _extends({}, props, {
        className: className,
        style: style,
    ...
    }, /*#__PURE__*/React.createElement(SearchInput, _extends({}, props, {
      ref: inputRef,
      needAlign: true
    })));
  });
