...
var SelectorList = function SelectorList(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_CSSMotionList["default"], {
    keys: nodeKeys,
    ...
    if (type === NODE_SELECTOR) {
      return /*#__PURE__*/_react["default"].createElement(_Selection["default"], _extends({}, props, {
        className: className,
        style: style,
    ...
    }, /*#__PURE__*/_react["default"].createElement(_SearchInput["default"], _extends({}, props, {
      ref: inputRef,
      needAlign: true
    })));
  });
